...
// Slow animated gradient-mesh blobs. The drifting embers + cursor-reactive
// warm glow now live in <EmberField /> (canvas) for performance.
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(251,191,36,0.30), transparent 65%)', filter: 'blur(60px)' }}
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(52,211,153,0.26), transparent 65%)', filter: 'blur(70px)' }}
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(129,140,248,0.24), transparent 65%)', filter: 'blur(80px)' }}
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(251,146,60,0.18), transparent 65%)', filter: 'blur(70px)' }}
